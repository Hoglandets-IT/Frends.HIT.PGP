...
namespace Frends.HIT.Pgp.Tests
{
    ...
    class PgpEncryptTests
    {
        ...
        private static readonly string PublicKeyPath = SolutionDir + @"\TestData\pgpencrypt-pub.asc";
        private static readonly string MessagePath = SolutionDir + @"\TestData\pgpcleartextsignature-pgpencrypt-original_message.txt";
        private static readonly string EncryptedMessage = SolutionDir + @"\TestData\pgpdecrypt-encrypted_message.pgp";

        private readonly string _privateKey = @"Frends.Community.PgpEncryptFile.Tests\TestData\pgpencrypt-privatekey.gpg";
